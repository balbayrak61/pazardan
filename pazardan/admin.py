...
class CustomUserAdmin(BaseUserAdmin):
    ...
    fieldsets=(
        ...
        ('personal info',{'fields':('first_name','last_name','email','bio','kocation')}),
        ('permissions',{'fields':('is_activate','is_staff','is_superuser')}),
        ('imported dates',{'fields':('last_login','date_joined',)}),
